 ...
 */
+ (instancetype)subscriptionWithSubscriptionURL:(nonnull NSURL *)eventSubscriptionURL serviceIdentifier:(nonnull NSString *)uniqueServiceName;
...
/**
 ...
 @return Returns a new subscription object.
 */
+ (instancetype)subscriptionWithID:(nonnull NSString *)subscriptionID expiryDate:(nonnull NSDate *)expiryDate eventSubscriptionURL:(nonnull NSURL *)eventSubscriptionURL serviceIdentifier:(nonnull NSString *)uniqueServiceName;
